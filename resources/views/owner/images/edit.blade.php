            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        @method('put')
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                    <div class="relative">
                                        <div class="w-32">
                                            <x-thumbnail :filename="$image->name" type="products" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form id="delete_{{ $image->id }}" action="{{ route('owner.images.destroy', ['image' => $image->id]) }}" method="post">
                        ...
                        @csrf
                        <div class="p-2 w-full flex justify-around mt-4">
                            <a href="#" data-id="{{ $image->id }}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除
                            </a>
                        </div>
                    </form>
                </div>
