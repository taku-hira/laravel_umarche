                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                            ...
                            <div class="swiper-container">
                                ...
                                <!-- Slides -->
                                    <div class="swiper-slide">
                                        @if ($product->imageFirst->name !== null)
                                            <img src="{{ asset('storage/products/' . $product->imageFirst->name )}}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageSecond->name !== null)
                                            <img src="{{ asset('storage/products/' . $product->imageSecond->name )}}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageThird->name !== null)
                                            <img src="{{ asset('storage/products/' . $product->imageThird->name )}}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                                    <div class="swiper-slide">
                                        @if ($product->imageFourth->name !== null)
                                            <img src="{{ asset('storage/products/' . $product->imageFourth->name )}}">
                                        @else
                                            <img src="">
                                        @endif
                                    </div>
                        ...
                        <div class="md:w-1/2 ml-4">
                            <h2 class="mb-4 text-sm title-font text-gray-500 tracking-widest">{{ $product->category->name }}E</h2>
